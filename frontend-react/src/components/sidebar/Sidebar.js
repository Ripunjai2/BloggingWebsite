  ...
  return (
    <div className='sidebar'>
      <div className='sidebarItem'>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate qui necessitatibus nostrum illum reprehenderit.</p>
      </div>
      <div className='sidebarItem'>
        ...
        <ul className='sidebarList'>
          ...
          <li className='sidebarListItem'>Instrospection</li>
        </ul>
      </div>
      <div className='sidebarItem'>
